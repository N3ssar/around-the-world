...
import CounteryCard from "./CountryCard";
...
function CountryList() {
  ...
  if (countries.length === 0) {
    return (
      <section className="px-12 pb-20 sm:px-0">
        <Container>
          <div className="flex min-h-[50vh] flex-col items-center justify-center text-center">
            <svg
              className="mb-8 h-auto w-full max-w-[300px] text-gray-800 transition-colors duration-300 dark:text-gray-200"
              viewBox="0 0 416 344"
              fill="none"
            ...
            >
              ...
              <path
                ...
                className="fill-gray-900 dark:fill-gray-600"
              />
            ...
            <p className="mt-2 max-w-sm text-gray-500 dark:text-gray-400">
              We can't find the country you searched for... <br />
  ...
  return (
    <section className="px-12 pb-20 sm:px-0">
      <Container className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {countries.map((country) => (
          <Link to={`/${country.cca3}`} key={country.cca3}>
            <CounteryCard country={country} />
          </Link>
        ))}
      </Container>
    </section>
